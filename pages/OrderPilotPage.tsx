          ...
          <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <InputField label="Phone Number" id="phone" name="phone" type="tel" required disabled={loading} />
                     <div>
                        ...
                        <select id="preferredContact" name="preferredContact" className={inputClasses} disabled={loading}>
                            <option>Phone</option>
                            <option>Email</option>
                        </select>
                    </div>
            ...
            <div className="p-4 border rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     <div>
                        ...
                        <textarea id="pickupAddress" name="pickupAddress" className={inputClasses} rows={3} required disabled={loading}></textarea>
                    </div>
                     <div>
                        <label className="block text-sm font-medium text-slate-600 mb-1" htmlFor="deliveryAddress">Delivery Address</label>
                        <textarea id="deliveryAddress" name="deliveryAddress" className={inputClasses} rows={3} required disabled={loading}></textarea>
                    </div>
            ...
            <div className="p-4 border rounded-lg">
                 ...
                 <div className="mt-4">
                     ...
                     <textarea id="additionalNotes" name="additionalNotes" className={inputClasses} rows={3} disabled={loading}></textarea>
                 </div>
            </div>
...
const InputField: React.FC<InputFieldProps> = ({ label, id, ...props }) => (
    <div>
        ...
        <input id={id} {...props} className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary disabled:bg-slate-100" />
    </div>
);

export default OrderPilotPage;
